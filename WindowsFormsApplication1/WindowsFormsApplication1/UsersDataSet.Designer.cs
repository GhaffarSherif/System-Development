...
namespace WindowsFormsApplication1 {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Username, string Password, string User_Type) {
...
namespace WindowsFormsApplication1.UsersDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Username] = @Original_Username) AND ([Password" +
                "] = @Original_Password) AND ([User Type] = @Original_User_Type))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Username], [Password], [User Type]) VALUES (@Username" +
                ", @Password, @User_Type);\r\nSELECT Username, Password, [User Type] FROM [Table] W" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Username] = @Username, [Password] = @Password, [User Type] = @User_Type WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([User Type] = @Original_User_Type));
SELECT Username, Password, [User Type] FROM [Table] WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication1.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, [User Type] FROM dbo.[Table]";
